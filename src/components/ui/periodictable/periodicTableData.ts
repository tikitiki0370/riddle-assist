// Periodic table grid layout (standard 18-column form)

// Main table: 7 rows × 18 columns (periods 1-7)
export const PERIODIC_TABLE_MAIN: (string | null)[][] = [
  // Period 1
...
// Lanthanides and Actinides: 2 rows × 18 columns
export const PERIODIC_TABLE_EXTRA: (string | null)[][] = [
  // Lanthanides (57-71)
...
// Atomic number lookup by symbol
